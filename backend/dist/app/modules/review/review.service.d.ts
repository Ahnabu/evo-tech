export declare const ReviewServices: {
    ...
    addReviewIntoDB: (productId: string, payload: any, imageBuffer?: Buffer) => Promise<import("mongoose").Document<unknown, {}, import("./review.interface").TReview, {}, {}> & import("./review.interface").TReview & Required<{
        _id: string;
    }> & {
        __v: number;
    }>;

    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1[class|style],h2[class|style],h3[class|style],h4[class|style],h5[class|style],h6[class|style],b,u,strong,i,em,s,del,a[href|title|class|style],ul[class|style],ol[class|style],li[class|style],p[class|style],br,span[class|style],img[src|alt|width|height|class|style],blockquote',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding,color,background-color,text-align,list-style-type,list-style-position',

...
const config: Config = {
	...
	theme: {
		extend: {
			...
			boxShadow: {
				...
				hrbase: '2px 0px 3px -1px var(--tw-shadow-color), -2px 0px 3px -1px var(--tw-shadow-color)',
				...
				inbase: 'inset 11px 11px 6px -8px var(--tw-shadow-color), inset -11px -11px 6px -8px var(--tw-shadow-color)',
	...
	plugins: [
		...
		plugin(function ({ matchUtilities, theme }: { matchUtilities: any; theme: any; }): void {
			matchUtilities(
				{

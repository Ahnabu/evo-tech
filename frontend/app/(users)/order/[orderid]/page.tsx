...
import { IoCheckmarkCircle, IoAlertCircle, IoTimeOutline, IoCard } from "react-icons/io5";
            ...
            case "pending":
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        ...
                        <span className="text-amber-600">{"Your order has been placed. Waiting for confirmation!"}</span>
                    </div>
                );
            case "confirmed":
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        ...
                        <span className="text-emerald-600">{"Your order has been confirmed and is being processed."}</span>
                    </div>
                );
            case "processing":
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        ...
                        <span className="text-blue-600">{"Your order is being processed."}</span>
                    </div>
                );
            case "shipped":
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        <IoCheckmarkCircle className="w-5 h-5 text-emerald-600" />
                        <span className="text-emerald-600">{"Your order has been shipped and is on its way!"}</span>
                    </div>
                );
            case "delivered":
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        <IoCheckmarkCircle className="w-5 h-5 text-emerald-600" />
                        <span className="text-emerald-600">{"Your order has been delivered. Thank you for your purchase!"}</span>
                    </div>
                );
            case "cancelled":
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        ...
                        <span className="text-rose-500">{"Oh! Your order has been cancelled. Please contact us if you have any questions."}</span>
                    </div>
                );
            default:
                return (
                    <div className="flex items-center gap-2 animate-in fade-in duration-500">
                        ...
                        <span className="text-amber-600">{"Current status of your order is unknown. Please contact us if you have any questions."}</span>
                    </div>
                );
        }
    };

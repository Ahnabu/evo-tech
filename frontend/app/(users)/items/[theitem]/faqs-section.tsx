  ...
  return (
    ...
    >
      <div className="flex w-fit h-fit py-2 max-sm:px-3">
        <h1 className="w-fit h-fit text-center text-[20px] leading-7 sm:text-[22px] sm:leading-8 lg:text-[27px] lg:leading-10 tracking-tight font-[600] text-stone-100">
          FAQs
        </h1>
      </div>
        ...
        {ifaqsdata.length > 0 && (
          <Accordion
            ...
            itemClasses={{
              ...
              title:
                "text-[13px] sm:text-[14px] leading-5 tracking-tight font-[600] text-stone-100",
              trigger:
                "px-3 sm:px-4 data-[open=true]:bg-stone-500/10 rounded-b-[4px] transition-[background-color] duration-100",
          ...
          >
            {ifaqsdata.map((faq: any, idx: number) => (
              <AccordionItem
                ...
                title={faq.question}
                indicator={<IoChevronDown className="inline w-4 h-4" />}
              >

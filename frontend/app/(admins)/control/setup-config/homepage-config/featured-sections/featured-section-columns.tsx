...
export const getFeaturedSectionColumns = (): ColumnDef<FeaturedSectionDisplayType>[] => {
    return [
        {
            accessorKey: "title",
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return (
                    <div className="text-left font-[500] whitespace-nowrap truncate text-xs">{row.getValue("view_more_url")}</div>
                )
            },
        },
        {
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return (
                    <div className="text-center text-xs">{row.getValue("items_count")}</div>
                )
            },
        },
        {
            ...
            cell: ({ row }) => {
                return (
                    <FeaturedSectionTableRowActions row={row} />
                )
            },
        },
    ];

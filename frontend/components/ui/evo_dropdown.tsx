...
const EvoDropdown = ({
  ...
  return (
    <Dropdown
      ...
      classNames={{
        content:
          "z-[1] outline-none box-border rounded-[8px] shadow-md p-1 w-fit h-fit bg-white border border-stone-300 min-w-0",
      }}
    >
      <DropdownTrigger>
        <button
          ...
          className={cn(
            "relative z-[0] flex w-fit h-fit pl-2 pr-[24px] py-1 sm:py-1.5 text-[12px] leading-5 font-[500] text-stone-700 bg-white border border-stone-300 rounded-[6px] overflow-hidden focus-visible:outline-none",
            dropdownTriggerClassName
          )}
        >
      ...
      <DropdownMenu
        ...
        itemClasses={{
          ...
          title:
            "text-[12px] sm:text-[13px] leading-5 font-[500] text-stone-700",
        }}
      >
        {children as any}
      </DropdownMenu>

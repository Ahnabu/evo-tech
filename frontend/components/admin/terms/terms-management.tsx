...
export function TermsManagement() {
    ...
    const makeAuthRequest = React.useCallback(async (method: string, url: string, data?: any) => {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.message || 'Failed to delete terms and conditions');
        }
    };
    ...
    const handleActivate = async (id: string) => {
        try {
            ...
            toast.error(error.response?.data?.message || 'Failed to activate terms and conditions');
        }
    };
    ...
    return (
        <div className="space-y-6">
            {isLoading ? (
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>{editingId ? 'Update' : 'Create New'} Terms & Conditions</CardTitle>
                        <CardDescription>
                            {editingId 
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Enter the full terms and conditions. You can use markdown formatting.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
            ...
            <div className="space-y-4">
                <h3 className="text-lg font-semibold">Terms & Conditions History</h3>
                {termsData.length === 0 ? (
                    <Card>
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-2">
                                                <CardTitle className="text-base">Version {terms.version}</CardTitle>
                                                {terms.isActive && (
                                            ...
                                            <CardDescription>
                                                Last updated: {new Date(terms.updatedAt).toLocaleDateString()} at{' '}
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {!terms.isActive && (
                                                <Button 
                                                    variant="outline" 
                                                    size="sm" 
                                                    className={deleteConfirm === terms._id ? "text-red-600 border-red-600" : "text-red-600"}

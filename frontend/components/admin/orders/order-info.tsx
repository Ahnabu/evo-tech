...
const getPaymentStatusBadge = (status: string) => {
    ...
    return (
        <Badge variant={config.variant} className="text-[0.625rem] leading-none py-0.5 font-medium">
            {config.text}
        </Badge>
    );
};
...
const OrderInfo = ({ orderData }: { orderData: OrderWithItemsType }) => {
    ...
    return (
        <>
            {/* Order Update Form */}
            <OrderUpdateForm orderData={orderData} onSuccess={handleStatusUpdate} />
                ...
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <Card className="bg-stone-50">
                        ...
                        <CardContent className="text-xs text-stone-500 space-y-2">
                            ...
                            {orderData.postcode && <p className="w-full h-fit">
                    ...
                    <Card className="bg-stone-50">
                        ...
                        <CardContent>
                            {orderData.orderItems && orderData.orderItems.length > 0 ? (
                                <div className="space-y-4">
                                    ...
                                    <div className="border-t border-stone-200 pt-4 space-y-2 text-xs">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-stone-800">{currencyFormatBDT(orderData.subtotal)} BDT</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-stone-600">Discount:</span>
                                            <span className="text-stone-800">-{currencyFormatBDT(orderData.discount)} BDT</span>
                                        </div>
                                        <div className="flex justify-between">
                                ...
                                <p className="text-stone-500 text-xs">No items found in this order.</p>
                            )}
                        </CardContent>
                    </Card>
                </div>

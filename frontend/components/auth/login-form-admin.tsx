...
const LoginFormAdmin = () => {
    ...
    return (
        <AuthCardWrapper
            headerLabel="Hey!"
            headerDescription="Let's see what's going on there"
        >
            <form id="userloginform" className="flex flex-col gap-3 w-full" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex justify-end w-full">
                    <Link href="/forgot-password" className="text-[12px] sm:text-[13px] leading-5 font-[500] text-stone-700 hover:text-stone-800 hover:underline">
                        Forgot password?
                    </Link>
                </div>

...
const NavBar = () => {
    ...
    const services: NavbarMenuType1[] = [
        ...
        { gotourl: "/services/laser-engraving", imgsrc: LaserEngravingService, name: "Laser Engraving", },
        { gotourl: "/services/thesis-writing", imgsrc: ThesisWritingService, name: "Thesis Writing", },
        { gotourl: "/services/project-development", imgsrc: ProjectDevService, name: "Project Development", },
        { gotourl: "/services/web-and-app-development", imgsrc: WebAppDevService, name: "Web & App Development", },
    ];
    ...
    const support: NavbarMenuType1[] = [
        ...
        { gotourl: "/about/warranty-policy", imgsrc: WarrantyPolicy, name: "Warranty Policy", },
        { gotourl: "/support/student-discount", imgsrc: StudentDiscount, name: "Student Discount", },
        { gotourl: "/about/sustainability", imgsrc: ShopShapeTomorrow, name: "Shop & Shape Tomorrow", },
